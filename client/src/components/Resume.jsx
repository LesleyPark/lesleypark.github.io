  ...
  render () {
    return (
      <div className={styles.resume}>
        TECHNICAL SKILLS
        <br />Front End | Javascript (ES5/ES6), React, AngularJS, HTML5, CSS3
        ...
        <br /><br />
        EDUCATION
        <br />Hack Reactor | Advanced Software Engineering Immersive			      	June 2018 - September 2018
        <br />University of Southern California | B.S. Chemical Engineering			      August 2005 - May 2009
        <br /><br />
        PROFESSIONAL EXPERIENCE
        <br />Associate Field Applications Engineer | Semtech Corporation			         March 2010 - May 2018
        ...
        <br />Airbnb Listing Replication | Javascript (ES5/ES6), React, HTML5, CSS3, PostgreSQL, AWS EC2
        <ul><li>Collaborative application that mirrors the design and functionality of Airbnb’s front end</li>
        <li>Implemented dynamically resizing photo header and gallery modal using React and CSS modules</li>
        ...
        <br />8th Rank Pawns | Ruby, Rails, HTML 5, CSS3, Heroku
        Player vs Player Chess Application built with a team of 5 developers
        <ul><li>Created wireframes and designed application front end</li>
        <li>Built legal piece movement validation and game status logic (e.g. check or stalemate)</li>
